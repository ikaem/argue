...
import RegisterForm from "../../components/register-form.component/register-form.component";
...
const LoginRegister = () => {
    ...
    const login = async () => {
        try {
            ...
            const loginResponse = await fetch(`https://secure-brook-13170.herokuapp.com/login`, {
                method: "post",
                credentials: "include",
                headers: {
    ...
    const register = async () => {
        try {
            ...
            const registerResponse = await fetch(`https://secure-brook-13170.herokuapp.com/register`, {
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                },
